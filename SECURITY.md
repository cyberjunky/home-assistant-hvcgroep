...
If you discover a security vulnerability in this integration, please report it privately by creating a [security advisory](https://github.com/cyberjunky/home-assistant-hvcgroep/security/advisories) on GitHub.
...
This integration communicates with HVC Groep over the internet (HTTPS):

- Keep your Home Assistant instance on a secure network

### Credential Storage

HVC Groep connection details (Postal code, House number) are stored in Home Assistant's configuration:
